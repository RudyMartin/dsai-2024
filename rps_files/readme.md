...
3. Upload the downloaded files into the `2024 raocck paper scissors` folder. 
...
After completing these steps, your Google Drive directory structure should look like this:
